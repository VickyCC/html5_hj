...
var GameSceneTime = cc.Scene.extend({
    ...
    init:function() {
        ...
        Game.user.m_timer = this.timeLayer.m_timer =20;
    ...
    update:function(elapsed) {
        ...
        if (this.timeLayer.m_timer<= 0) {
            this.timeLayer.m_timer=0;
            this.endGame();
        }
    }
