var UI = cc.Layer.extend({
    ...
    ctor:function(gameScene){
        ...
        var title = new cc.LabelBMFont("Rabbit WAS Succeed", fnt);
        this.addChild(title);
      ...
      /*  /////////////////////////////////微信分享箭头 微信中显示掌阅logo/////////////////////
        var wxShareBtn= new cc.MenuItemSprite(
         ...
         wxfxBtn.setPosition( winSize.width/2, winSize.height/2-250);
    ...
    /*wxShare:function (){
        ...
        var arrow = new cc.Sprite("res/graphics/weixin.png");
